...
package com.qhzk.ciep.library_zxing.camera;
...
import com.qhzk.ciep.library_zxing.DisplayUtil;
...
public final class CameraManager {
    ...
    public Rect getFramingRect() {
        ...
        if (FRAME_MARGINTOP == -1) {
            topOffset = (screenResolution.y - FRAME_HEIGHT) / 2 - DisplayUtil.dip2px(DisplayUtil.context, 46.00f);
        } else {
