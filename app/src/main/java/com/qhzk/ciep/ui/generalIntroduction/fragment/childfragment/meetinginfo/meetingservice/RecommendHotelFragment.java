...
public class RecommendHotelFragment extends BaseFragment<RecommendHotelPresenter> implements RecommendHotelView {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_recommend_hotel;
    }
...
//        webSettings.setBuiltInZoomControls(true);
    ...
    protected void initdata() {
        super.initdata();
        mFragmentPresenter.loadData("tuijianjiudian");
    }
