...
public class UnitGuideFragment extends BaseFragment<UnitGuidePresenter> implements UnitGuideView{

    private WebView mWebView;
    private ProgressBar mProgressBar;
    @Override
    protected int getLayoutId() {
        return R.layout.fragment_unit_exhibition_guide;
    }
...
//        webSettings.setBuiltInZoomControls(true);
    ...
    protected void initdata() {
        super.initdata();
        mFragmentPresenter.loadData("danweicanzhanzhinan");
    }
