...
public class TrafficGuideFragment extends BaseFragment<TrafficGuidePresenter> implements TrafficGuideView {

    private WebView mWebView;
    private ProgressBar mProgressBar;
    @Override
    protected int getLayoutId() {
        return R.layout.fragment_traffic_guide;
    }
...
//        webSettings.setBuiltInZoomControls(true);
    ...
    protected void initdata() {
        super.initdata();
        mFragmentPresenter.loadData("jiaotongzhinan");
    }
