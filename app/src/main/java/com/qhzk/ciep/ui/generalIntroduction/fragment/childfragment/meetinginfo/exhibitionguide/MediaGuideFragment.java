...
public class MediaGuideFragment extends BaseFragment<MediaGuidePresenter> implements MediaGudieView{

    private WebView mWebView;
    private ProgressBar mProgressBar;
    @Override
    protected int getLayoutId() {
        return R.layout.fragment_media_guide;
    }
    ...
    protected void initdata() {
        super.initdata();
        mFragmentPresenter.loadData("meiticanhui");
    }
