...
public class ProjectTypeDialog extends Dialog {

    private ArrayList<String> mExpectSalarys;
    private WheelView mWheelView;

    public ProjectTypeDialog(Context context, OnSelectListener l) {
        this(context, R.style.Theme_Light_Dialog);
        mOnCountrySelectListener = l;
    }

    public ProjectTypeDialog(Context context, int themeResId) {
    ...
    private void init(Context context) {
        ...
        String[] expectSalary = context.getResources().getStringArray(R.array.projecttype);
