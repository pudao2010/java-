...
public class UnitPropertyDialog extends Dialog {
    ...
    public UnitPropertyDialog(Context context, OnSelectListener l) {
        this(context, R.style.Theme_Light_Dialog);
        mOnCountrySelectListener = l;
    }

    public UnitPropertyDialog(Context context, int themeResId) {
    ...
    private void init(Context context) {
        ...
        String[] expectSalary = context.getResources().getStringArray(R.array.unitproperty);
