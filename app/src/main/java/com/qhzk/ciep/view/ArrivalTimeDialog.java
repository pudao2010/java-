...
public class ArrivalTimeDialog extends Dialog {
    ...
    public ArrivalTimeDialog(Context context, OnSelectListener l) {
        this(context, R.style.Theme_Light_Dialog);
        mOnCountrySelectListener = l;
    }

    public ArrivalTimeDialog(Context context, int themeResId) {
    ...
    private void init(Context context) {
        ...
        String[] expectSalary = context.getResources().getStringArray(R.array.arrivaltime);
