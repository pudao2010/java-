...
public class MajorDialog extends Dialog {
    ...
    public MajorDialog(Context context, OnSelectListener l) {
        this(context, R.style.Theme_Light_Dialog);
        mOnCountrySelectListener = l;
    }

    public MajorDialog(Context context, int themeResId) {
    ...
    private void init(Context context) {
        ...
        String[] expectSalary = context.getResources().getStringArray(R.array.major);
