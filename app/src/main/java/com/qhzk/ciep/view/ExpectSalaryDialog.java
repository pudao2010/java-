...
public class ExpectSalaryDialog extends Dialog {

    private ArrayList<String> mExpectSalarys;
    private WheelView mWheelView;

    public ExpectSalaryDialog(Context context, OnSelectListener l) {
        this(context, R.style.Theme_Light_Dialog);
        mOnCountrySelectListener = l;
    }

    public ExpectSalaryDialog(Context context, int themeResId) {
    ...
    private void init(Context context) {
        ...
        String[] expectSalary = context.getResources().getStringArray(R.array.salary);
