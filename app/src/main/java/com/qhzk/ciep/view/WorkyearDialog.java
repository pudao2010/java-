...
public class WorkyearDialog extends Dialog {

    private ArrayList<String> mExpectSalarys;
    private WheelView mWheelView;

    public WorkyearDialog(Context context, OnSelectListener l) {
        this(context, R.style.Theme_Light_Dialog);
        mOnCountrySelectListener = l;
    }

    public WorkyearDialog(Context context, int themeResId) {
