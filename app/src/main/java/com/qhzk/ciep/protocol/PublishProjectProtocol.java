...
public class PublishProjectProtocol extends CiepProtocol {
    public PublishProjectProtocol(Callback mCallback) {
        super(mCallback);
    }
    ...
    public String getUrl() {
        return ServiceConfig.BASE_URL + "common/project/add.action";
    }
