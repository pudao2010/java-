...
/**
 * Created by pucheng on 2017/3/3.
 * 带有回弹空间的ViewPager
 */
...
public class BounceBackViewPager extends ViewPager {
    ...
    private void init(AttributeSet attrs) {
        ...
        mOverscrollTranslation = a.getDimension(R.styleable.BounceBackViewPager_overscroll_translation,
                DEFAULT_OVERSCROLL_TRANSLATION);
        mOverscrollAnimationDuration = a.getInt(R.styleable.BounceBackViewPager_overscroll_animation_duration,
